 ...
 *          drawGravityForce: Used to see gravity area.
 *			drawGravityForceGizmos: Used to see gravity area from gizmos.
 *          
 * 
*******************************************************************************************/
using UnityEngine;
...
namespace CircularGravityForce
{
    public class CircularGravity : MonoBehaviour
    {
        ...
        public class DrawGravityProperties
        {
            ...
            public bool drawGravityForceGizmos = true;
        }
        ...
        void OnDrawGizmos()
        {
            if (drawGravityProperties.drawGravityForceGizmos)
            {
                string iconURL = "..\\CircularGravity Package\\Gizmos\\";

                switch (shape)
                {
                    case Shape.Sphere:
                        iconURL = iconURL + "cgf_s_icon";
                        break;
                    case Shape.Capsule:
                        iconURL = iconURL + "cgf_c_icon";
                        break;
                    case Shape.RayCast:
                        iconURL = iconURL + "cgf_r_icon";
                        break;
                }

                if (forcePower >= 0)
                {
                    iconURL = iconURL + "1.png";
                }
                else if (forcePower < 0)
                {
                    iconURL = iconURL + "2.png";
                }

                Gizmos.DrawIcon(this.transform.position, iconURL, true);
            }
