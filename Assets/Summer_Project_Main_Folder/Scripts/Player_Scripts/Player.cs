...
public class Player : Photon.MonoBehaviour
{
    ...
    private void InputMovement()
    {
        ...
        if(Input.GetKeyDown(KeyCode.Space)){
            GetComponent<Rigidbody>().AddForce(Vector3.up * jumpHeight * Time.deltaTime,ForceMode.VelocityChange);
        }
    ...
    {
        currentColor = GetComponent<Renderer>().material.GetColor("_Color");
